...
import Mizuharabot.modules.sql.notes_sql as sql
from Mizuharabot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Mizuharabot.__main__ import DATA_IMPORT
from Mizuharabot.modules.helper_funcs.chat_status import user_admin
from Mizuharabot.modules.helper_funcs.alternate import typing_action

# from Mizuharabot.modules.rules import get_rules
import Mizuharabot.modules.sql.rules_sql as rulessql

# from Mizuharabot.modules.sql import warns_sql as warnssql
import Mizuharabot.modules.sql.blacklist_sql as blacklistsql
from Mizuharabot.modules.sql import disable_sql as disabledsql

# from Mizuharabot.modules.sql import cust_filters_sql as filtersql
# import Mizuharabot.modules.sql.welcome_sql as welcsql
import Mizuharabot.modules.sql.locks_sql as locksql
from Mizuharabot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Mizuharabot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Mizuharabot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Mizuhara-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Mizuharabot{}.backup".format(chat_id))  # Cleaning file
