...
from Mizuharabot.__main__ import STATS, TOKEN, USER_INFO
import Mizuharabot.modules.sql.userinfo_sql as sql
...
from Mizuharabot.modules.sql.afk_sql import is_afk, check_afk_status
from Mizuharabot.modules.sql.users_sql import get_user_num_chats
from Mizuharabot.modules.helper_funcs.chat_status import sudo_plus
from Mizuharabot.modules.helper_funcs.extraction import extract_user
from Mizuharabot import telethn as YoneTelethonClient, TIGERS, DRAGONS, DEMONS
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>📊 Mizuhara's Current stats:</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
