...
from Mizuharabot import BOT_USERNAME, OWNER_ID, pbot, arq
from Mizuharabot.pyrogramee.pluginshelper import convert_seconds_to_minutes as time_convert
from Mizuharabot.pyrogramee.pluginshelper import fetch
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/MizuharaSLBot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Mizuhara](https://github.com/dihanofficial/Mizuharabot):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
